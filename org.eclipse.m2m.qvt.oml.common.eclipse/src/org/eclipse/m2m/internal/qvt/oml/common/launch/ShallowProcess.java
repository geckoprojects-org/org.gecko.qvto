...
import org.eclipse.m2m.internal.qvt.oml.common.eclipse.CommonPlugin;
...
public class ShallowProcess extends BaseProcess {
	...
	public int getExitValue() throws DebugException {
		if(!isTerminated()) {
			throw new DebugException(new Status(IStatus.ERROR, CommonPluginConstants.ID, 1, Messages.IProcess_InvalidState, null));
		}
